...
class PluginContratosLicitacion  extends CommonDBTM { 
   ...
   public $table = 'glpi_plugin_contratos_licitacions';
   public $type  = 'PluginContratosLicitacion';
 //[INICIO] [CRI] JMZ18G CAMBIOS CORE - Heredar los permisos del objeto contract
 //static $rightname = "plugin_contratos_licitacion";
   static $rightname = "contract";
 //[INICIO] [CRI] JMZ18G CAMBIOS CORE  - Heredar los permisos del objeto contract 
   
   static function getTypeName($nb = 0) {
      return "Importes licitación";
   }   
